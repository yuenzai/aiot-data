...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return cn.ecosync.aiot.data.prometheus.api.PrometheusProto.internal_static_io_prometheus_write_v2_TimeSeries_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return cn.ecosync.aiot.data.prometheus.api.PrometheusProto.internal_static_io_prometheus_write_v2_TimeSeries_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            cn.ecosync.aiot.data.prometheus.api.TimeSeries.class, cn.ecosync.aiot.data.prometheus.api.TimeSeries.Builder.class);
  }
  ...
  @SuppressWarnings("serial")
  private java.util.List<cn.ecosync.aiot.data.prometheus.api.Sample> samples_;
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public java.util.List<cn.ecosync.aiot.data.prometheus.api.Sample> getSamplesList() {
    return samples_;
  }
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public java.util.List<? extends cn.ecosync.aiot.data.prometheus.api.SampleOrBuilder> 
   ...
   */
  @java.lang.Override
  public cn.ecosync.aiot.data.prometheus.api.Sample getSamples(int index) {
   ...
   */
  @java.lang.Override
  public cn.ecosync.aiot.data.prometheus.api.SampleOrBuilder getSamplesOrBuilder(
      int index) {
    return samples_.get(index);
  }
  ...
  @SuppressWarnings("serial")
  private java.util.List<cn.ecosync.aiot.data.prometheus.api.Histogram> histograms_;
  /**
   * <code>repeated .io.prometheus.write.v2.Histogram histograms = 3;</code>
   */
  @java.lang.Override
  public java.util.List<cn.ecosync.aiot.data.prometheus.api.Histogram> getHistogramsList() {
    return histograms_;
  }
  /**
   * <code>repeated .io.prometheus.write.v2.Histogram histograms = 3;</code>
   */
  @java.lang.Override
  public java.util.List<? extends cn.ecosync.aiot.data.prometheus.api.HistogramOrBuilder> 
   ...
   */
  @java.lang.Override
  public cn.ecosync.aiot.data.prometheus.api.Histogram getHistograms(int index) {
   ...
   */
  @java.lang.Override
  public cn.ecosync.aiot.data.prometheus.api.HistogramOrBuilder getHistogramsOrBuilder(
      int index) {
    return histograms_.get(index);
  }
  ...
  @SuppressWarnings("serial")
  private java.util.List<cn.ecosync.aiot.data.prometheus.api.Exemplar> exemplars_;
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public java.util.List<cn.ecosync.aiot.data.prometheus.api.Exemplar> getExemplarsList() {
    return exemplars_;
  }
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public java.util.List<? extends cn.ecosync.aiot.data.prometheus.api.ExemplarOrBuilder> 
   ...
   */
  @java.lang.Override
  public cn.ecosync.aiot.data.prometheus.api.Exemplar getExemplars(int index) {
   ...
   */
  @java.lang.Override
  public cn.ecosync.aiot.data.prometheus.api.ExemplarOrBuilder getExemplarsOrBuilder(
      int index) {
    return exemplars_.get(index);
  }

  public static final int METADATA_FIELD_NUMBER = 5;
  private cn.ecosync.aiot.data.prometheus.api.Metadata metadata_;
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public cn.ecosync.aiot.data.prometheus.api.Metadata getMetadata() {
    return metadata_ == null ? cn.ecosync.aiot.data.prometheus.api.Metadata.getDefaultInstance() : metadata_;
  }
  /**
   * <pre>
   * metadata represents the metadata associated with the given series' samples.
   ...
   */
  @java.lang.Override
  public cn.ecosync.aiot.data.prometheus.api.MetadataOrBuilder getMetadataOrBuilder() {
    return metadata_ == null ? cn.ecosync.aiot.data.prometheus.api.Metadata.getDefaultInstance() : metadata_;
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof cn.ecosync.aiot.data.prometheus.api.TimeSeries)) {
      return super.equals(obj);
    }
    cn.ecosync.aiot.data.prometheus.api.TimeSeries other = (cn.ecosync.aiot.data.prometheus.api.TimeSeries) obj;
  ...
  public static cn.ecosync.aiot.data.prometheus.api.TimeSeries parseFrom(
  ...
  public static cn.ecosync.aiot.data.prometheus.api.TimeSeries parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static cn.ecosync.aiot.data.prometheus.api.TimeSeries parseFrom(
  ...
  public static cn.ecosync.aiot.data.prometheus.api.TimeSeries parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static cn.ecosync.aiot.data.prometheus.api.TimeSeries parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessage
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static cn.ecosync.aiot.data.prometheus.api.TimeSeries parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessage
  ...
  public static Builder newBuilder(cn.ecosync.aiot.data.prometheus.api.TimeSeries prototype) {
  ...
  public static final class Builder extends
      ...
      cn.ecosync.aiot.data.prometheus.api.TimeSeriesOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return cn.ecosync.aiot.data.prometheus.api.PrometheusProto.internal_static_io_prometheus_write_v2_TimeSeries_descriptor;
    }
    ...
    // Construct using cn.ecosync.aiot.data.prometheus.api.TimeSeries.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public cn.ecosync.aiot.data.prometheus.api.TimeSeries getDefaultInstanceForType() {
      return cn.ecosync.aiot.data.prometheus.api.TimeSeries.getDefaultInstance();
    }

    @java.lang.Override
    public cn.ecosync.aiot.data.prometheus.api.TimeSeries build() {
      cn.ecosync.aiot.data.prometheus.api.TimeSeries result = buildPartial();
    ...
    @java.lang.Override
    public cn.ecosync.aiot.data.prometheus.api.TimeSeries buildPartial() {
      cn.ecosync.aiot.data.prometheus.api.TimeSeries result = new cn.ecosync.aiot.data.prometheus.api.TimeSeries(this);
    ...
    private void buildPartialRepeatedFields(cn.ecosync.aiot.data.prometheus.api.TimeSeries result) {
      if (samplesBuilder_ == null) {
    ...
    private void buildPartial0(cn.ecosync.aiot.data.prometheus.api.TimeSeries result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof cn.ecosync.aiot.data.prometheus.api.TimeSeries) {
        return mergeFrom((cn.ecosync.aiot.data.prometheus.api.TimeSeries)other);
      } else {
    ...
    public Builder mergeFrom(cn.ecosync.aiot.data.prometheus.api.TimeSeries other) {
      if (other == cn.ecosync.aiot.data.prometheus.api.TimeSeries.getDefaultInstance()) return this;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              cn.ecosync.aiot.data.prometheus.api.Sample m =
                  input.readMessage(
                      cn.ecosync.aiot.data.prometheus.api.Sample.parser(),
                      extensionRegistry);
              if (samplesBuilder_ == null) {
                ensureSamplesIsMutable();
                samples_.add(m);
            ...
            case 26: {
              cn.ecosync.aiot.data.prometheus.api.Histogram m =
                  input.readMessage(
                      cn.ecosync.aiot.data.prometheus.api.Histogram.parser(),
                      extensionRegistry);
              if (histogramsBuilder_ == null) {
                ensureHistogramsIsMutable();
                histograms_.add(m);
            ...
            case 34: {
              cn.ecosync.aiot.data.prometheus.api.Exemplar m =
                  input.readMessage(
                      cn.ecosync.aiot.data.prometheus.api.Exemplar.parser(),
                      extensionRegistry);
              if (exemplarsBuilder_ == null) {
                ensureExemplarsIsMutable();
                exemplars_.add(m);
    ...
    private void ensureSamplesIsMutable() {
      if (!((bitField0_ & 0x00000002) != 0)) {
        samples_ = new java.util.ArrayList<cn.ecosync.aiot.data.prometheus.api.Sample>(samples_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilder<
        cn.ecosync.aiot.data.prometheus.api.Sample, cn.ecosync.aiot.data.prometheus.api.Sample.Builder, cn.ecosync.aiot.data.prometheus.api.SampleOrBuilder> samplesBuilder_;
    ...
    public Builder setSamples(
        int index, cn.ecosync.aiot.data.prometheus.api.Sample value) {
      if (samplesBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setSamples(
        int index, cn.ecosync.aiot.data.prometheus.api.Sample.Builder builderForValue) {
      if (samplesBuilder_ == null) {
        ensureSamplesIsMutable();
     ...
     * <code>repeated .io.prometheus.write.v2.Sample samples = 2;</code>
     */
    public Builder addSamples(cn.ecosync.aiot.data.prometheus.api.Sample value) {
      if (samplesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addSamples(
        cn.ecosync.aiot.data.prometheus.api.Sample.Builder builderForValue) {
      if (samplesBuilder_ == null) {
        ensureSamplesIsMutable();
    ...
    public Builder addAllSamples(
        java.lang.Iterable<? extends cn.ecosync.aiot.data.prometheus.api.Sample> values) {
      if (samplesBuilder_ == null) {
        ensureSamplesIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, samples_);
     ...
     * <code>repeated .io.prometheus.write.v2.Sample samples = 2;</code>
     */
    public cn.ecosync.aiot.data.prometheus.api.Sample.Builder getSamplesBuilder(
        int index) {
     ...
     * <code>repeated .io.prometheus.write.v2.Sample samples = 2;</code>
     */
    public cn.ecosync.aiot.data.prometheus.api.Sample.Builder addSamplesBuilder() {
      return internalGetSamplesFieldBuilder().addBuilder(
          cn.ecosync.aiot.data.prometheus.api.Sample.getDefaultInstance());
    }
    /**
     * <pre>
     * Timeseries messages can either specify samples or (native) histogram samples
    ...
    public cn.ecosync.aiot.data.prometheus.api.Sample.Builder addSamplesBuilder(
        int index) {
      return internalGetSamplesFieldBuilder().addBuilder(
          index, cn.ecosync.aiot.data.prometheus.api.Sample.getDefaultInstance());
    }
    /**
     * <pre>
     * Timeseries messages can either specify samples or (native) histogram samples
     ...
     * <code>repeated .io.prometheus.write.v2.Sample samples = 2;</code>
     */
    public java.util.List<cn.ecosync.aiot.data.prometheus.api.Sample.Builder> 
         getSamplesBuilderList() {
      return internalGetSamplesFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilder<
        cn.ecosync.aiot.data.prometheus.api.Sample, cn.ecosync.aiot.data.prometheus.api.Sample.Builder, cn.ecosync.aiot.data.prometheus.api.SampleOrBuilder> 
        internalGetSamplesFieldBuilder() {
      if (samplesBuilder_ == null) {
    ...
    private void ensureHistogramsIsMutable() {
      if (!((bitField0_ & 0x00000004) != 0)) {
        histograms_ = new java.util.ArrayList<cn.ecosync.aiot.data.prometheus.api.Histogram>(histograms_);
        bitField0_ |= 0x00000004;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilder<
        cn.ecosync.aiot.data.prometheus.api.Histogram, cn.ecosync.aiot.data.prometheus.api.Histogram.Builder, cn.ecosync.aiot.data.prometheus.api.HistogramOrBuilder> histogramsBuilder_;
    ...
    public Builder setHistograms(
        int index, cn.ecosync.aiot.data.prometheus.api.Histogram value) {
      if (histogramsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setHistograms(
        int index, cn.ecosync.aiot.data.prometheus.api.Histogram.Builder builderForValue) {
      if (histogramsBuilder_ == null) {
        ensureHistogramsIsMutable();
     ...
     * <code>repeated .io.prometheus.write.v2.Histogram histograms = 3;</code>
     */
    public Builder addHistograms(cn.ecosync.aiot.data.prometheus.api.Histogram value) {
      if (histogramsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addHistograms(
        cn.ecosync.aiot.data.prometheus.api.Histogram.Builder builderForValue) {
      if (histogramsBuilder_ == null) {
        ensureHistogramsIsMutable();
    ...
    public Builder addAllHistograms(
        java.lang.Iterable<? extends cn.ecosync.aiot.data.prometheus.api.Histogram> values) {
      if (histogramsBuilder_ == null) {
        ensureHistogramsIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, histograms_);
     ...
     * <code>repeated .io.prometheus.write.v2.Histogram histograms = 3;</code>
     */
    public cn.ecosync.aiot.data.prometheus.api.Histogram.Builder getHistogramsBuilder(
        int index) {
     ...
     * <code>repeated .io.prometheus.write.v2.Histogram histograms = 3;</code>
     */
    public cn.ecosync.aiot.data.prometheus.api.Histogram.Builder addHistogramsBuilder() {
      return internalGetHistogramsFieldBuilder().addBuilder(
          cn.ecosync.aiot.data.prometheus.api.Histogram.getDefaultInstance());
    }
    /**
     * <code>repeated .io.prometheus.write.v2.Histogram histograms = 3;</code>
     */
    public cn.ecosync.aiot.data.prometheus.api.Histogram.Builder addHistogramsBuilder(
        int index) {
      return internalGetHistogramsFieldBuilder().addBuilder(
          index, cn.ecosync.aiot.data.prometheus.api.Histogram.getDefaultInstance());
    }
    /**
     * <code>repeated .io.prometheus.write.v2.Histogram histograms = 3;</code>
     */
    public java.util.List<cn.ecosync.aiot.data.prometheus.api.Histogram.Builder> 
         getHistogramsBuilderList() {
      return internalGetHistogramsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilder<
        cn.ecosync.aiot.data.prometheus.api.Histogram, cn.ecosync.aiot.data.prometheus.api.Histogram.Builder, cn.ecosync.aiot.data.prometheus.api.HistogramOrBuilder> 
        internalGetHistogramsFieldBuilder() {
      if (histogramsBuilder_ == null) {
    ...
    private void ensureExemplarsIsMutable() {
      if (!((bitField0_ & 0x00000008) != 0)) {
        exemplars_ = new java.util.ArrayList<cn.ecosync.aiot.data.prometheus.api.Exemplar>(exemplars_);
        bitField0_ |= 0x00000008;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilder<
        cn.ecosync.aiot.data.prometheus.api.Exemplar, cn.ecosync.aiot.data.prometheus.api.Exemplar.Builder, cn.ecosync.aiot.data.prometheus.api.ExemplarOrBuilder> exemplarsBuilder_;
    ...
    public Builder setExemplars(
        int index, cn.ecosync.aiot.data.prometheus.api.Exemplar value) {
      if (exemplarsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setExemplars(
        int index, cn.ecosync.aiot.data.prometheus.api.Exemplar.Builder builderForValue) {
      if (exemplarsBuilder_ == null) {
        ensureExemplarsIsMutable();
     ...
     * <code>repeated .io.prometheus.write.v2.Exemplar exemplars = 4;</code>
     */
    public Builder addExemplars(cn.ecosync.aiot.data.prometheus.api.Exemplar value) {
      if (exemplarsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addExemplars(
        cn.ecosync.aiot.data.prometheus.api.Exemplar.Builder builderForValue) {
      if (exemplarsBuilder_ == null) {
        ensureExemplarsIsMutable();
    ...
    public Builder addAllExemplars(
        java.lang.Iterable<? extends cn.ecosync.aiot.data.prometheus.api.Exemplar> values) {
      if (exemplarsBuilder_ == null) {
        ensureExemplarsIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, exemplars_);
     ...
     * <code>repeated .io.prometheus.write.v2.Exemplar exemplars = 4;</code>
     */
    public cn.ecosync.aiot.data.prometheus.api.Exemplar.Builder getExemplarsBuilder(
        int index) {
     ...
     * <code>repeated .io.prometheus.write.v2.Exemplar exemplars = 4;</code>
     */
    public cn.ecosync.aiot.data.prometheus.api.Exemplar.Builder addExemplarsBuilder() {
      return internalGetExemplarsFieldBuilder().addBuilder(
          cn.ecosync.aiot.data.prometheus.api.Exemplar.getDefaultInstance());
    }
    /**
     * <pre>
     * exemplars represents an optional set of exemplars attached to this series' samples.
    ...
    public cn.ecosync.aiot.data.prometheus.api.Exemplar.Builder addExemplarsBuilder(
        int index) {
      return internalGetExemplarsFieldBuilder().addBuilder(
          index, cn.ecosync.aiot.data.prometheus.api.Exemplar.getDefaultInstance());
    }
    /**
     * <pre>
     * exemplars represents an optional set of exemplars attached to this series' samples.
     ...
     * <code>repeated .io.prometheus.write.v2.Exemplar exemplars = 4;</code>
     */
    public java.util.List<cn.ecosync.aiot.data.prometheus.api.Exemplar.Builder> 
         getExemplarsBuilderList() {
      return internalGetExemplarsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilder<
        cn.ecosync.aiot.data.prometheus.api.Exemplar, cn.ecosync.aiot.data.prometheus.api.Exemplar.Builder, cn.ecosync.aiot.data.prometheus.api.ExemplarOrBuilder> 
        internalGetExemplarsFieldBuilder() {
      if (exemplarsBuilder_ == null) {
    ...
    private com.google.protobuf.SingleFieldBuilder<
        cn.ecosync.aiot.data.prometheus.api.Metadata, cn.ecosync.aiot.data.prometheus.api.Metadata.Builder, cn.ecosync.aiot.data.prometheus.api.MetadataOrBuilder> metadataBuilder_;
    /**
     * <pre>
     * metadata represents the metadata associated with the given series' samples.
     * </pre>
     ...
     * <code>.io.prometheus.write.v2.Metadata metadata = 5;</code>
     */
    public Builder setMetadata(cn.ecosync.aiot.data.prometheus.api.Metadata value) {
      if (metadataBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setMetadata(
        cn.ecosync.aiot.data.prometheus.api.Metadata.Builder builderForValue) {
      if (metadataBuilder_ == null) {
     ...
     * <code>.io.prometheus.write.v2.Metadata metadata = 5;</code>
     */
    public Builder mergeMetadata(cn.ecosync.aiot.data.prometheus.api.Metadata value) {
      if (metadataBuilder_ == null) {
        if (((bitField0_ & 0x00000010) != 0) &&
          metadata_ != null &&
          metadata_ != cn.ecosync.aiot.data.prometheus.api.Metadata.getDefaultInstance()) {
     ...
     * <code>.io.prometheus.write.v2.Metadata metadata = 5;</code>
     */
    public cn.ecosync.aiot.data.prometheus.api.Metadata.Builder getMetadataBuilder() {
      bitField0_ |= 0x00000010;
      onChanged();
    ...
    public cn.ecosync.aiot.data.prometheus.api.MetadataOrBuilder getMetadataOrBuilder() {
      if (metadataBuilder_ != null) {
        ...
        return metadata_ == null ?
            cn.ecosync.aiot.data.prometheus.api.Metadata.getDefaultInstance() : metadata_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilder<
        cn.ecosync.aiot.data.prometheus.api.Metadata, cn.ecosync.aiot.data.prometheus.api.Metadata.Builder, cn.ecosync.aiot.data.prometheus.api.MetadataOrBuilder> 
        internalGetMetadataFieldBuilder() {
      if (metadataBuilder_ == null) {
  ...
  private static final cn.ecosync.aiot.data.prometheus.api.TimeSeries DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new cn.ecosync.aiot.data.prometheus.api.TimeSeries();
  }

  public static cn.ecosync.aiot.data.prometheus.api.TimeSeries getDefaultInstance() {
