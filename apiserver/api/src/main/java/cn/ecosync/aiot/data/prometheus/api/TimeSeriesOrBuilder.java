...
public interface TimeSeriesOrBuilder extends
   ...
   */
  java.util.List<cn.ecosync.aiot.data.prometheus.api.Sample> 
      getSamplesList();
  /**
   * <pre>
   * Timeseries messages can either specify samples or (native) histogram samples
   ...
   * <code>repeated .io.prometheus.write.v2.Sample samples = 2;</code>
   */
  cn.ecosync.aiot.data.prometheus.api.Sample getSamples(int index);
  /**
   * <pre>
   * Timeseries messages can either specify samples or (native) histogram samples
   * (histogram field), but not both. For a typical sender (real-time metric
   ...
   * <code>repeated .io.prometheus.write.v2.Sample samples = 2;</code>
   */
  java.util.List<? extends cn.ecosync.aiot.data.prometheus.api.SampleOrBuilder> 
   ...
   * <code>repeated .io.prometheus.write.v2.Sample samples = 2;</code>
   */
  cn.ecosync.aiot.data.prometheus.api.SampleOrBuilder getSamplesOrBuilder(
      int index);

  /**
   * <code>repeated .io.prometheus.write.v2.Histogram histograms = 3;</code>
   */
  java.util.List<cn.ecosync.aiot.data.prometheus.api.Histogram> 
      getHistogramsList();
  /**
   * <code>repeated .io.prometheus.write.v2.Histogram histograms = 3;</code>
   */
  cn.ecosync.aiot.data.prometheus.api.Histogram getHistograms(int index);
  /**
   * <code>repeated .io.prometheus.write.v2.Histogram histograms = 3;</code>
   */
   ...
   * <code>repeated .io.prometheus.write.v2.Histogram histograms = 3;</code>
   */
  java.util.List<? extends cn.ecosync.aiot.data.prometheus.api.HistogramOrBuilder> 
      getHistogramsOrBuilderList();
  /**
   * <code>repeated .io.prometheus.write.v2.Histogram histograms = 3;</code>
   */
  cn.ecosync.aiot.data.prometheus.api.HistogramOrBuilder getHistogramsOrBuilder(
      int index);
   ...
   */
  java.util.List<cn.ecosync.aiot.data.prometheus.api.Exemplar> 
      getExemplarsList();
  /**
   * <pre>
   * exemplars represents an optional set of exemplars attached to this series' samples.
   ...
   * <code>repeated .io.prometheus.write.v2.Exemplar exemplars = 4;</code>
   */
  cn.ecosync.aiot.data.prometheus.api.Exemplar getExemplars(int index);
  /**
   * <pre>
   * exemplars represents an optional set of exemplars attached to this series' samples.
   * </pre>
   ...
   * <code>repeated .io.prometheus.write.v2.Exemplar exemplars = 4;</code>
   */
  java.util.List<? extends cn.ecosync.aiot.data.prometheus.api.ExemplarOrBuilder> 
   ...
   * <code>repeated .io.prometheus.write.v2.Exemplar exemplars = 4;</code>
   */
  cn.ecosync.aiot.data.prometheus.api.ExemplarOrBuilder getExemplarsOrBuilder(
      int index);
   ...
   * @return The metadata.
   */
  cn.ecosync.aiot.data.prometheus.api.Metadata getMetadata();
  /**
   * <pre>
   * metadata represents the metadata associated with the given series' samples.
   * </pre>
   ...
   * <code>.io.prometheus.write.v2.Metadata metadata = 5;</code>
   */
  cn.ecosync.aiot.data.prometheus.api.MetadataOrBuilder getMetadataOrBuilder();
